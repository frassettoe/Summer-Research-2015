...
def main():
    ...
    LEHRList = []
    numberVertices=4
    c1 = 0.0653882637103883
    c2 = 0.0152189924611065
    c3 = 0.0570831458430882
    c4 = 0.0211942486478845
    c5 = 0.0322485007383834
    conformalVariations = [ 0.083352077,0.118396462,0.124391183,0.050802242,0.117261114,2.587421008 ]
    #seed=4741252
    #seed=263594
    seed=56932684
    random.seed(seed)
